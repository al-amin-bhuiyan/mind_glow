...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get journeyTabTitle => 'Journey';
  ...
  @override
  String get pastReflections => 'Your past reflections';
  ...
  @override
  String get yourReflectionsSoFar => 'Your reflections so far';

  @override
  String reflectionsWrittenStat(int count) {
    return '$count reflections written';
  }

  @override
  String themesExploredStat(int count) {
    return '$count themes explored';
  }

  @override
  String reflectedDaysStat(int count) {
    return 'Reflected over $count days';
  }
